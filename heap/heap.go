...
// MaxHeap struct has a slic that holds the array
type MaxHeap struct {
	array []int
}
...
func (h *MaxHeap) maxHeapifyDown(index int) {
	...
	for l <= lastIndex {
		...
		//compare array value of current index to larger child swap if smaller
...
func main() {
	...
	buildHeap := []int{10, 20, 30, 10, 121, 212, 65, 32, 23, 100, 202}
